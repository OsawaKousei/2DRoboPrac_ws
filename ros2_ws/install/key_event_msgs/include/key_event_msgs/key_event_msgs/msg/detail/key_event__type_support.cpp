...
{
  new (message_memory) key_event_msgs::msg::KeyEvent(_init);
}

void KeyEvent_fini_function(void * message_memory)
{
  auto typed_message = static_cast<key_event_msgs::msg::KeyEvent *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KeyEvent_message_member_array[1] = {
  {
    ...
    offsetof(key_event_msgs::msg::KeyEvent, key),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeyEvent_message_members = {
  "key_event_msgs::msg",  // message namespace
  "KeyEvent",  // message name
  1,  // number of fields
  sizeof(key_event_msgs::msg::KeyEvent),
...
{
  return &::key_event_msgs::msg::rosidl_typesupport_introspection_cpp::KeyEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, key_event_msgs, msg, KeyEvent)() {
  return &::key_event_msgs::msg::rosidl_typesupport_introspection_cpp::KeyEvent_message_type_support_handle;
}
