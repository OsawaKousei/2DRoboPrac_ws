...
static const _KeyEvent_type_support_symbol_names_t _KeyEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, key_event_msgs, msg, KeyEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, key_event_msgs, msg, KeyEvent)),
  }
};
...
{
  return &::key_event_msgs::msg::rosidl_typesupport_cpp::KeyEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, key_event_msgs, msg, KeyEvent)() {
  return get_message_type_support_handle<key_event_msgs::msg::KeyEvent>();
}
