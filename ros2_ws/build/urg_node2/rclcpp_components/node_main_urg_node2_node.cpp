...
#define NODE_MAIN_LOGGER_NAME "urg_node2_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liburg_node2.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<urg_node2::UrgNode2>";
