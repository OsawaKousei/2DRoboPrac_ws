...
def generate_launch_description():
    ...
    model_path = os.path.join(nav_dev_dir, "models")
    ...
    world = os.path.join(nav_dev_dir, "models", "worlds", "nav_slam.sdf")
    ...
    bridge = Node(
        ...
        parameters=[{
            #brigdeの設定ファイルを指定
            'config_file': os.path.join(nav_dev_dir, 'config', 'nav_slam.yaml'),
