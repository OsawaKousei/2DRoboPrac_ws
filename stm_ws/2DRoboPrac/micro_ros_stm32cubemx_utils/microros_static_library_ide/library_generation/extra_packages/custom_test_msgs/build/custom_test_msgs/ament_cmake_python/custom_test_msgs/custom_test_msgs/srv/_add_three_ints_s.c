...
bool custom_test_msgs__srv__add_three_ints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_test_msgs.srv._add_three_ints.AddThreeInts_Request", full_classname_dest, 57) == 0);
  }
  custom_test_msgs__srv__AddThreeInts_Request * ros_message = _ros_message;
  {  // a
...
PyObject * custom_test_msgs__srv__add_three_ints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_test_msgs.srv._add_three_ints");
...
ROSIDL_GENERATOR_C_EXPORT
bool custom_test_msgs__srv__add_three_ints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_test_msgs.srv._add_three_ints.AddThreeInts_Response", full_classname_dest, 58) == 0);
  }
  custom_test_msgs__srv__AddThreeInts_Response * ros_message = _ros_message;
  {  // sum
