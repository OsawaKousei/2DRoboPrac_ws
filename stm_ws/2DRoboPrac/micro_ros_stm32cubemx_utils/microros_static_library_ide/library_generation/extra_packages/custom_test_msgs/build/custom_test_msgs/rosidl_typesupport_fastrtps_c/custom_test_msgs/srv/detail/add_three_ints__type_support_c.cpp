...
#include "custom_test_msgs/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_c.h"
...
#include "custom_test_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _AddThreeInts_Request__ros_msg_type = custom_test_msgs__srv__AddThreeInts_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_test_msgs
size_t get_serialized_size_custom_test_msgs__srv__AddThreeInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddThreeInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_test_msgs__srv__AddThreeInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_test_msgs
size_t max_serialized_size_custom_test_msgs__srv__AddThreeInts_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddThreeInts_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_test_msgs__srv__AddThreeInts_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_test_msgs, srv, AddThreeInts_Request)() {
...
using _AddThreeInts_Response__ros_msg_type = custom_test_msgs__srv__AddThreeInts_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_test_msgs
size_t get_serialized_size_custom_test_msgs__srv__AddThreeInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddThreeInts_Response__ros_msg_type * ros_message = static_cast<const _AddThreeInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_test_msgs__srv__AddThreeInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_test_msgs
size_t max_serialized_size_custom_test_msgs__srv__AddThreeInts_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddThreeInts_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_test_msgs__srv__AddThreeInts_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_test_msgs, srv, AddThreeInts_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_test_msgs, srv, AddThreeInts)() {
