...
class Metaclass_AddThreeInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('custom_test_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_test_msgs.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_test_msgs.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from custom_test_msgs.srv._add_three_ints import AddThreeInts_Request as Request
    from custom_test_msgs.srv._add_three_ints import AddThreeInts_Response as Response
